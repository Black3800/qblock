...
class PublicKey:
    ...
    def __init__(self, sk=None, *, h=None, n=None):
        ...
        if sk != None:
            ...
            self.n = n
            self.h = h
            self.hash_to_point = lambda message,salt : SecretKey.hash_to_point(self, message, salt)
            self.signature_bound = Params[n]["sig_bound"]
            self.sig_bytelen = Params[n]["sig_bytelen"]
            self.verify = lambda message,signature : SecretKey.verify(self, message, signature)
